                ...
                <div className="navbar-brand">
                    <div >
                        ...
                        <img src={dynamicContextState.eng.megh_Logo.link} width={250} />
                             {/* <img src={`${globalContextState.server.uploads}/files/download/${dynamicContextState.eng.megh_Logo.link}`} alt="d" width={200} /> */}
                        </strong>
                    </div>
                        ...
                        <div className="navbar-item">
                            <div className="buttons">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href={dynamicContextState[lang].call_us_phone.link} className="text-reset">
                                            <strong> {dynamicContextState[lang].call_us_phone.title} </strong>
                                        </a>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href={dynamicContextState[lang].enquiry_us_id.link} className="has-text-link">
                                            <strong> {dynamicContextState[lang].enquiry_us_id.title} </strong>
                                        </a>
