                    ...
                    <div className="box has-text-centered">
                        ...
                        <div className="file is-info has-name">
                            <label className="file-label">      
                                ...
                                <input className="file-input" type="file" name="resume" onChange={(e) => {fileTypeHandlers.fileTypeDataUpdateHandler(e); validationHandlers.fileTypeValidatorHandler(e.target.value) }} />
