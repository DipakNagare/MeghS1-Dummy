                ...
                <div className="container text-center text-md-start mt-5">
                    ...
                    <div className="row mt-3">
                        ...
                        <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <h6 className="text-uppercase fw-bold mb-4">
                                <strong>{dynamicContextState[lang].usefull_links}</strong>
                            </h6>
                            <p>
                                <a href={dynamicContextState[lang].footerPoweredBy.link} className="text-reset">
                                    <strong>{dynamicContextState[lang].footerPoweredBy.title}</strong>
                                </a>
                            ...
                            <p>
                                <a href={dynamicContextState[lang].footerMeghS.link} className="text-reset">
                                    <strong>{dynamicContextState[lang].footerMeghS.title}</strong>
                                </a>
                            ...
                            <p>
                                <a href={dynamicContextState[lang].footerHelp.link} className="text-reset">
                                    <strong>{dynamicContextState[lang].footerHelp.title}</strong>
                                </a>
                               {globalContextState.editMode && <button className="button ml-2 is-small is-dark" onClick={() => { linkTypeHandlers.linkTypeModalUpdateHandler("footerHelp") }}>
                                    <i className="fa-solid fa-pen"></i>
                                </button>}
