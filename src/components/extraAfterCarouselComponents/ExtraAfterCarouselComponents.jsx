                                    ...
                                    <div className="card">
                                        <div className="card-image">
                                            <figure className="image is-16by9">
                                                <img src={`${globalContextState.server.uploads}/files/download/${dynamicContextState.eng.HOPPA_image.link}`} alt="Placeholder image" />
                                            </figure>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-sm-4">
                                            <div className="counter-box box3 text-center">
                                                ...
                                                <p> <strong>{dynamicContextState[lang].courses.value}</strong>
                                                    {globalContextState.editMode && <button className="button ml-2 is-small is-dark" onClick={() => { textTypeHandlers.textTypeModalUpdateHandler("courses") }}>
                                                        <i className="fa-solid fa-pen"></i>
                                                    </button>}
                                                </p>
                                            </div>
