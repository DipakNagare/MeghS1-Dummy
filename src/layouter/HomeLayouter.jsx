...
const HomeLayouter = () => {
    ...
    return (
        <div>
            ...
            <Header globalHandlers={globalHandlers} globalContextState={globalContextState} dynamicContextState={dynamicContextState} textTypeHandlers={textTypeHandlers} lang={globalContextState.lang}/>
